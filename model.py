...
class DCGAN(object):
    def __init__(self, sess, image_size=64, is_crop=False,
        ...
        self.d_bns = [batch_norm(name='d_bn{}'.format(i, )) for i in range(1, 4)]
    ...
    def build_model(self):
        ...
        # t_vars = [var for var in tf.trainable_variables() if not var.name.startswith('logits')]
...
""")
    ...
    def discriminator(self, image, reuse=False):
        with tf.variable_scope("discriminator") as scope:
            ...
            h4 = linear(tf.reshape(h3, [-1, self.batch_size]), 1, 'd_h3_lin')
